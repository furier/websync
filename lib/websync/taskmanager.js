    ...
    function executeRsyncTask(rsync, id) {
        ...
        rsync.execute(
            function (error, code, cmd) {
                io.sockets.emit('task.finished.' + id, { error: error ? error.toString() : error, code: code, cmd: cmd });
            }, function (data) {
                io.sockets.emit('task.progress.' + id, data.toString());
            }, function (data) {
                io.sockets.emit('task.error.' + id, data.toString());
            }
        );
